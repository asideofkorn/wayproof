...
| `geometry/v0/snapshots/usgs-*-routes-*.geojson` | USGS National Digital Trails / The National Map | `public_domain` | U.S. Government work. Each bounded snapshot retains selected feature identifiers, source metadata, and source-published length fields; Wayproof relationships determine reviewed route membership rather than spatial proximity. |
| `geometry/v0/snapshots/nps-yose-tuolumne-pois-20260925.geojson` | National Park Service Public Points of Interest feature service | `public_domain` | U.S. Government work. This bounded reviewed snapshot retains selected NPS feature identifiers for display; it does not infer access, membership, operating status, or route topology from proximity. |
| `geometry/v0/snapshots/nps-yose-yosemite-valley-pois-20260925.geojson` | National Park Service Public Points of Interest feature service | `public_domain` | U.S. Government work. This bounded reviewed Yosemite Valley snapshot retains selected NPS feature identifiers for display; it does not infer access, membership, operating status, or route topology from proximity. |
| `geometry/v0/snapshots/nps-yose-valley-route-features-20260926.geojson` | National Park Service Public Trails feature service | `public_domain` | U.S. Government work. The snapshot contains reviewed Four Mile, Yosemite Falls, John Muir, and Mist Trail features. Official descriptions establish route membership and endpoints; exact dataset endpoints establish segment continuity without proximity snapping. |
| `geometry/v0/snapshots/nps-yose-glacier-point-route-features-20260926.geojson` | National Park Service Public Trails feature service | `public_domain` | U.S. Government work. The bounded snapshot contains seven reviewed physical segments for Sentinel Dome, Taft Point, and McGurk Meadow. The official Glacier Point Road map establishes route identity and physical endpoints; exact dataset endpoints establish shared continuity without proximity snapping. |
| `geometry/v0/snapshots/nps-yose-hetch-hetchy-route-features-20260926.geojson` | National Park Service Public Trails feature service | `public_domain` | U.S. Government work. The bounded snapshot contains the reviewed Wapama Falls shoreline chain and Poopenaut Valley Trail. The official Hetch Hetchy map establishes route identity and endpoints; exact dataset endpoints establish continuity without proximity snapping. |
| `geometry/v0/snapshots/nps-yose-west-tioga-route-features-20260926.geojson` | National Park Service Public Trails feature service | `public_domain` | U.S. Government work. The bounded snapshot contains the reviewed named May Lake and Lukens Lake trail features. Official NPS day-hike descriptions establish their starts and objectives; dataset geometry supplies display shape, not segment mileage or proximity-derived relationships. |
