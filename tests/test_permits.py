...
def test_conflict_kind_says_how_each_open_conflict_must_be_resolved():
    ...
    assert kinds == {
        ...
        # Briones' own brochure says five business days; four other EBRPD
        # surfaces say three. The brochure is the newest of the five, so
        # recency cannot settle it either.
        "briones-group-lead-time": "cross_source",
    }
